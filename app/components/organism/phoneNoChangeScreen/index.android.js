...
import { Background, Border, Padding, Alignment, Fonts, Column, ImageSize, Margin, Colors } from 'theme';
...
export default function ProfileEditorScreen({
    ...
    const [firtsName, setfirtsName] = useState('Tuan');
        ...
        <Container>
            ...
            <Content >
                ...
                <View style={{ backgroundColor: '#FFF', width: wp(100), padding: '5%', marginTop: '3%' }}>
                    ...
                    <TouchableOpacity onPress={() => bsPhone.open()} style={{ position: 'absolute', right: 15, top: 15, zIndex: 888 }}>
                ...
                <View style={{ backgroundColor: '#FFF', width: wp(100), padding: '5%', marginTop: '3%' }}>
                    ...
                    <Text style={{ ...Fonts.f_10, color: '#a0a4a8', padding: 5 }}>
                        Semua Informasi transaksi & keamanan akunmu akan
                ...
                <CustomBottomSheet
                    ...
                    rBSheetHeight={100}
                >
                    <View style={{ width: '100%', paddingLeft: '5%', paddingRight: '5%', paddingTop: 10, marginBottom: 5 }}>
                        ...
                        <View style={{
                            ...
                            <PhoneFieldInput phoneNumber={phoneNumber} onChangeText={onChangePhoneNumber} placeholder={'cth: 000000000'} />
                        </View>
                    </View>
                    <View style={{ width: '100%', paddingLeft: '5%', paddingRight: '5%', marginTop: 40 }}>
                        <PrimaryButton onPress={onSave} style={{ backgroundColor: Colors.amber, height: 50 }} text={labelSubmit} />
                    </View>
                </CustomBottomSheet>
            </Content>
...
ProfileEditorScreen.defaultProps = {
    ...
    labelName: 'Nama',
    onPressTitle: (a, b) => { console.log(a, b) },
    onPress: () => { },
    ...
    onChangePhoneNumber: (a) => { console.log },
