...
import { Row, Border, Padding, Fonts, Colors, Margin, Background } from 'theme'
    ...
    >
      {noBorderTop ? (
        <View style={{
          ...
          { isCart && <View style={{ flexDirection: 'column', width: '100%' }}>
              <View style={{ ...Padding.ph_16, ...Padding.pt_16 }}>
                <CheckBox
                  checked={selected}
                  onCheck={(isCheck) => {changeSelected(isCheck)}}
                >
                  <View>
          ...
          <View style={{             
            ...
            <Text style={{ ...Margin.mt_16, ...Fonts.f_8, ...Fonts.bold }}>
                  {isCart ? 'Total' : basePriceLabel}</Text>
