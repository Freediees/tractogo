...
export default function SortFilterButton({
  ...
  return (
    ...
    >
      ...
      <CustomBottomSheet height={'50%'} title={sortTitleLabel} botSheetRef={(ref) => (bsSort = ref)}>
      ...
      <CustomBottomSheet title={filterTitleLabel} botSheetRef={(ref) => (bsFilter = ref)}>
        <View style={{ width: '100%', ...Row.row_2, ...Padding.ph_20 }}>
        ...
        <View style={{ ...Padding.ph_20, ...Margin.mv_20, ...Row.row_1_5 }}>
        ...
        <View style={{ width: '100%', ...Row.row_1, ...Margin.mt_8, ...Padding.ph_20 }}>
          <PrimaryButton
            onPress={() => {
