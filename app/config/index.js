...
export const SERVICE_ID_WITH_DRIVER = 'PSV0002'
...
export const REGEX_PHONE_NUMBER = /^(^\+62\s?|^0)(\d{3,4}-?){2}\d{3,4}$/
...
export const CAR_RENTAL_BUID = '0104'
export const AIRPORT_TRANSFER_BUID = '0104'
export const BUS_RENTAL_BUID = '0201'
// SERVICE TYPE
...
const BASE_URL_BTC = (prm) => `${PROTOCOL}//omni-service-${prm}.azurewebsites.net/api/v2/b2c` // PRD
const BASE_URL = (prm) => `${PROTOCOL}//omni-service-${prm}.azurewebsites.net/api/v2` // PRD
...
export const LOGIN_VERIFY = `${BASE_URL_BTC('authorization')}/authorization/confirmation/`
...
export const CHECKOUT = `${BASE_URL_BTC('order')}/order/reservation/checkout`
export const CHECKOUT_VALIDATION = `${BASE_URL_BTC('order')}/order/reservation/checkout-validation`
export const CART_DETAIL = (args) =>
  `${BASE_URL_BTC('order')}/order/reservation/cart-detail/${args}`
export const MY_ORDERS_ACTIVE = `${BASE_URL_BTC('order')}/order/reservation/get-my-booking`
...
//export const PUT_UPDATE_PROFILE = 'http://omni-service-authorization.azurewebsites.net/api/v2/b2c/authorization/user-profile/update/'
export const PUT_KYC_IMAGES = `http://omni-service-authorization.azurewebsites.net/api/v2/b2c/authorization/user-profile/kyc/`
// export const PUT_PHONE_NUMBER = `${BASE_URL_BTC('authorization')}user-profile/change-number-phone`
//export const PUT_PHONE_NUMBER = 'http://omni-service-authorization.azurewebsites.net/api/b2c/authorization/user-profile/change-number-phone'

export const NOTIFICATION_BY_USER = `${BASE_URL(
  'notification'
)}/notification/notification-history/get-by-param?UserId=`
export const PAYMENT_METHOD = `${BASE_URL_BTC(
  'configuration'
